...
Dupilumab currently holds **no marketing authorization** in Norway according to this evidence pack (market status: Not marketed / Not Marketed; 0 total authorizations; no license records available).
