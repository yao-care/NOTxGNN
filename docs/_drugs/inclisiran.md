...
Inclisiran is currently **not marketed** in Norway — `taiwan_regulatory.market_status = "Not marketed"`, with **0 authorizations** on file. No license records are available to summarize.
