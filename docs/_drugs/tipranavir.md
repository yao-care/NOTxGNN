...
Tipranavir is not currently marketed in Norway (`market_status: Not marketed`) and has 0 registered authorizations. No license records are available for this evidence pack.
