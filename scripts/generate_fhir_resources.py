...
BASE_URL = "https://notxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "notxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "NOTxGNNFHIRServer",
        "title": "NOTxGNN FHIR Server - Norway Drug Repurposing",
        "description": "FHIR R4 server for Norway TxGNN drug repurposing predictions",
        "status": "active",
